...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.MyViewHolder> {
    ...
    Context context;
    ArrayList<Data> myDoes;

    public DataAdapter(Context c, ArrayList<Data> p) {
        this.context = c;
        this.myDoes = p;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new MyViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_does,viewGroup, false));
    }
